...
const SVG_GEOMETRY: Record<string, string> = {
  wall: '<line> with x1,y1,x2,y2 (wall centerline). stroke-width should match CSV thickness.',
...
export function generateSkill(): string {
  ...
  lines.push('7. **Wall thickness** in CSV and SVG `stroke-width` should match. CSV is source of truth.');
